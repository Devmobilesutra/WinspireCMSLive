...
public class StructureAdapter extends ArrayAdapter<Structure> {

    private ArrayList<Structure> dataSet;
    Context mContext;
    ...
    public StructureAdapter(ArrayList<Structure> data, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Structure dataModel = getItem(position);
