...
public class TransferOrderTransferTypeAdapter extends ArrayAdapter<TransferOrderTransferType> {

    private ArrayList<TransferOrderTransferType> dataSet;
    Context mContext;
    ...
    public TransferOrderTransferTypeAdapter(ArrayList<TransferOrderTransferType> data, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TransferOrderTransferType dataModel = getItem(position);
        ...
        viewHolder.txtName.setText(dataModel.getTexts());
