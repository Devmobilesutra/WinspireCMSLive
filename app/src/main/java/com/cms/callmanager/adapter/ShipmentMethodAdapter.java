...
public class ShipmentMethodAdapter extends ArrayAdapter<ShippingMethodCode> {

    private ArrayList<ShippingMethodCode> dataSet;
    Context mContext;
    ...
    public ShipmentMethodAdapter(ArrayList<ShippingMethodCode> data, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ShippingMethodCode dataModel = getItem(position);
