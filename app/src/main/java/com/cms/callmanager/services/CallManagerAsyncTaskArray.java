...
public abstract class CallManagerAsyncTaskArray extends AsyncTask<Object, String, JSONArray> {
    ...
    public CallManagerAsyncTaskArray(String action , String reqType , Context context){
