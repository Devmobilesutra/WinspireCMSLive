...
public class GoodHubActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_good_hub);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle(getResources().getString(R.string.title_activity_good_hub));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(GoodHubActivity.this, GoodDetailsActivity.class);
        ...
        if(Utils.isInternetOn(this)){
            ProgressUtil.ShowBar(GoodHubActivity.this);
            EngineertoHubGoodAPI engineertoHubGoodAPI = new EngineertoHubGoodAPI(Constants.EngineertoHubGood+"?id=EngineertoHubGood"+"&UserId="+userId, "GET" ,
                    GoodHubActivity.this);
            engineertoHubGoodAPI.execute();
        }else{
           Utils.showAlertBox("Please Connect to internet",GoodHubActivity.this);
   ...
   //     stockTransferAdapter=new StockTransferAdapter(stockTransfers, getApplicationContext());
        LinearLayoutManager horizontalLayoutManager = new LinearLayoutManager(GoodHubActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private class StockTransferAdapter extends RecyclerView.Adapter<StockTransferAdapter.MyViewHolder> implements Filterable {
        ...
        public void onBindViewHolder(final StockTransferAdapter.MyViewHolder holder, final int position) {
          ...
          //  String values = "WBEGEBANK";

          /*  String[] values = { "WBEGEBANK", "APSGBHIM", "APSGHYDE"};
            for(int i=0; i < values.length; i++){

                if(values[i].contains(mFilteredList.get(position).getFrom_code())){*/
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            super.onBackPressed();
            Intent intent = new Intent(GoodHubActivity.this , InvTrasActivity.class);
...
/*
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.good_hub, menu);
        return true;
    }*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.inventoryTransfer :
                startActivity(new Intent(GoodHubActivity.this, InvTrasActivity.class));
                finish();
                break;
            case R.id.searchCall :
                Intent searchIntent = new Intent(GoodHubActivity.this , searchCallActivity.class);
                startActivity(searchIntent);
                finish();
                break;
            case R.id.nearestATM :
                //Toast.makeText()
                Intent intent = new Intent(GoodHubActivity.this , NearestATMActivity.class);
                startActivity(intent);
                finish();
                break;
            case R.id.logout :
                Intent logoutIntent  = new Intent(GoodHubActivity.this , LoginActivity.class);
            ...
            case R.id.pendingCallList :
                Intent i  = new Intent(GoodHubActivity.this , HomeActivity.class);
                startActivity(i);
                finish();
                break;
            case R.id.rejectedCalls :
                Intent rejectedIntent  = new Intent(GoodHubActivity.this , RejectedCallList.class);
        ...
        protected void onPostExecute(JSONArray json) {
            ...
            if (json != null) {
                try {
                 ...
                 //   ArrayList<stockTransfer> filterlist = new ArrayList<>();
                 ...
                 //   String[] values = { "WBEGEBANK", "APSGBHIM", "APSGHYDE"};
                    ...
                    /*for(int k=0; k < list.size(); k++){
                        ...
                        for( j=0;j<values.length;j++){
                            ...
                            if(list.get(k).getFrom_code().contains(values[j])){

                                filterlist.add(new stockTransfer(list.get(k).getNumber(),
                                        list.get(k).getFrom_code(),
                                        list.get(k).getTo_code(),
                                        list.get(k).getStatus()));
                            }
                        }
                    }
*/
                    ...
                    e.printStackTrace();
                    Utils.showAlertBox("JSONException : " + e.getMessage(), GoodHubActivity.this);
                }
            } else {
                Utils.showAlertBox("No record(s) to display.", GoodHubActivity.this);
            }
        }
    }
}
