 ...
 */
public abstract class CallManagerAsyncTask1 extends AsyncTask<Object, String, JSONObject> {
    ...
    public CallManagerAsyncTask1(String action , String reqType , Context context){
